...
vowels = ["a", "i", "u", "e", "o", "n", "Sil", "-", "-"]

def genMIDI(minPitch, maxPitch, totalNotes):

    possibleDuration = [0.125, 0.25, 0.333, 0.5, 0.75, 1, 1.5, 2, 3, 4]
    track = 0
    time = 0
    tempo = 60
    channel = 0
    ...
    for i in range(0, totalNotes):
        noteDuration = possibleDuration[random.randrange(0,9)]
